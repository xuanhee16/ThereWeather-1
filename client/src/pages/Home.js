                ...
                <LeftContainer1>
                    ...
                    <LeftNav2>
                        ...
                        <ul>
                          ...
                          { weatherData && weatherData.item.map((info, idx) => { return <li kye={idx}>현재위치 하늘상태:{info.fcstValue  === "1" ? "강수량 없음" : info.fcstValue  === "3" ? "구름많음" : "흐림" }</li> })[18] } {/* SKY */}
                          { weatherData && weatherData.item.map((info, idx) => { return <li kye={idx}>현재위치 날씨상태:{info.fcstValue === "0" ? "맑음" : info.fcstValue === "3" ? "눈" : "비" }</li> })[6] } {/* PTY */}
                        </ul> 
                        </div>
                    </LeftNav2>
                    <LeftNav3>
